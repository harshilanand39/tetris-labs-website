...
const TRUST_PARTNERS = [
  ...
  { name: 'JP Morgan Chase', sources: logoSources('jpmorganchase') },
  { name: "Bloomingdale's", sources: logoSources() },
  { name: 'Rolex', sources: logoSources('rolex') },
  { name: 'Shutterstock', sources: logoSources('shutterstock') },
  { name: 'DoubleVerify', sources: logoSources('doubleverify') },
  { name: 'Interactive Brokers', sources: logoSources('interactivebrokers') },
  { name: 'Stack Overflow', sources: logoSources('stackoverflow') },
  { name: 'Betterment', sources: logoSources('betterment') },
  ...
  { name: 'Paxos', sources: logoSources('paxos') },
  { name: 'ZocDoc', sources: logoSources('zocdoc') },
  { name: 'Thrive Global', sources: logoSources() },
  { name: 'Weights & Biases', sources: logoSources('weightsandbiases') },
  { name: 'Teleport', sources: logoSources('teleport') },
  { name: 'Cursor', sources: logoSources('cursor') },
  { name: 'Pika Labs', sources: logoSources('pika') },
  { name: 'Clay', sources: logoSources('clay') },
  { name: 'Inflection AI', sources: logoSources('inflection') },
  { name: 'Codeium', sources: logoSources('windsurf') },
  { name: 'Verkada', sources: logoSources('verkada') },
  { name: 'Exa', sources: logoSources('exa') },
  { name: 'Cartesia', sources: logoSources('cartesia') },
  { name: 'MultiOn', sources: logoSources() },
  { name: 'Runway', sources: logoSources('runway') },
  { name: 'Vapi', sources: logoSources('vapi') },
  { name: 'Nooks', sources: logoSources('nooks') },
  { name: 'SandboxAQ', sources: logoSources('sandbox') },
  { name: 'Arkham Intelligence', sources: logoSources('arkham') },
  { name: 'OnDeck', sources: logoSources() },
  { name: 'Voyage AI', sources: logoSources() },
  { name: 'LeafLink', sources: logoSources('leaflink') },
  { name: 'TripleLift', sources: logoSources('triplelift') },
